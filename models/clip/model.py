...
def _clip_ebc(
    ...
    elif backbone in ["vit_b_16", "vit_b_32", "vit_l_14"]:
    ...
    #    decoder_block = BasicBlock  # Use BasicBlock for EfficientNetV2-S
    #    if decoder_cfg is None:
    #        decoder_cfg = [1280]  # Match EfficientNetV2-S feature map channels
