...
parser.add_argument("--contrast", type=float, default=0.5, help="The contrast factor for random color jitter augmentation.")
parser.add_argument("--saturation", type=float, default=0.3, help="The saturation factor for random color jitter augmentation.")
...
parser.add_argument("--eval_freq", type=int, default=2, help="Evaluate every this number of epochs.")
